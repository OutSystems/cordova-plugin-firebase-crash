 ...
 * @param {string} version - Version string like "3.0.0-OS17"
 * @returns {number} - The versionCode (17)
 */
 ...
 * @returns {string} - Next version like "3.0.0-OS18"
 */
...
async function getCommitsSinceLastTag() {
  try {
    ...
    // Example: 3.0.0-OS17, 3.0.0-OS18, etc.
